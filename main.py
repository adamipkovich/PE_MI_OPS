...
from src.streaming import RabbitMQConnection, Consumer
from src.backend.services.model_storage import ModelStorage
from src.backend.services.training_service import TrainingService
...
# Global instances
storage = ModelStorage(storage_dir="src/backend/models/saved")
